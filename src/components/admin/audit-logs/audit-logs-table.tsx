        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-8 dark:bg-gray-900 dark:border-gray-800 dark:text-gray-400"
            />
          </div>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="outline" size="sm" className="dark:bg-gray-900 dark:border-gray-800">
            ...
            <DropdownMenuContent align="end" className="dark:bg-gray-900 dark:border-gray-800">
              <DropdownMenuItem onClick={() => onFilter('ALL')} className="dark:hover:bg-gray-800">
...

      {
        logs.length === 0 ? (
          ...
          <div className="rounded-lg border dark:border-gray-800 bg-card dark:bg-gray-900/50 overflow-hidden theme-transition">
            <Table>
              <TableHeader>
                <TableRow className="dark:bg-gray-900/90 dark:hover:bg-gray-900/90 transition-colors duration-300">
                    ...
                    {logs.map((log, index) => {
                      ...
                      return (
                        <motion.tr
                          ...
                          className="dark:bg-gray-900/30 dark:hover:bg-gray-800/50"
                        >
                          <TableCell>
          ...
          >
            ...
            <div className="flex space-x-2">
              <Button
                ...
                className="transition-transform hover:scale-105 dark:bg-gray-900 dark:border-gray-800"
              >
