            ...
            <div className="grid items-center gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-4 p-4 md:px-6">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  ...
                  <Button
                    variant="outline"
                    className="border-[var(--custom-celeste)] text-[var(--custom-blue)] hover:bg-blue-50"
                  >
                    Learn more
              ...
              <div className="flex items-center justify-center">
                <div className="grid grid-cols-2 gap-4 w-full">
                  <Card className="p-6 border border-[var(--custom-celeste)] bg-white/50 backdrop-blur-sm hover:shadow-md transition-all duration-200 flex flex-col items-center text-center">
                  ...
                  <Card className="p-6 border border-[var(--custom-celeste)] bg-white/50 backdrop-blur-sm hover:shadow-md transition-all duration-200 flex flex-col items-center text-center">
                    ...
                    <h3 className="font-medium text-lg mb-2">Trustless Work</h3>
                    <p className="text-sm text-muted-foreground">
                  ...
                  <Card className="p-6 border border-[var(--custom-celeste)] bg-white/50 backdrop-blur-sm hover:shadow-md transition-all duration-200 flex flex-col items-center text-center">
                    ...
                    <h3 className="font-medium text-lg mb-2">Global Access</h3>
                    <p className="text-sm text-muted-foreground">
