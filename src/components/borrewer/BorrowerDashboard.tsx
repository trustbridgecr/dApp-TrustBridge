...
export function DashboardContent() {
  ...
  return (
    <main className="flex-1 p-6 bg-white dark:bg-darkbg text-black dark:text-white">
      <div className="w-full max-w-5xl mx-auto">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <Card className="bg-white dark:bg-darkbg dark:border-gray-700 border-gray-200">
